...
!    call mn_static_read_hires(npx, npy, 1, pelist, surface_dir, "sfc_data", "slmsk", parent_ls%ls_mask_grid, 1)
  ...
  subroutine mn_var_shift_data_r4_3d_highz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
    ...
    call mn_var_shift_data_r4_3d_lowhighz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, 1, nz)
  ...
  !>@details For one single precision 3D variable
  subroutine mn_var_shift_data_r4_3d_lowhighz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, z_low, z_high)
    ...
    logical, intent(in)                         :: take_action                              !< Perform move on this nest?
    type(nest_domain_type), intent(inout)       :: nest_domain                              !< Nest domain structure
    integer, intent(in)                         :: position, nest_level, z_low, z_high      !< Grid offset, number of vertical levels
    ...
    call alloc_halo_buffer(wbuffer, west_fine,  west_coarse,  nest_domain, WEST,   position, nest_level, z_low, z_high)
  ...
  subroutine mn_var_shift_data_r8_3d_highz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
    ...
    call mn_var_shift_data_r8_3d_lowhighz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, 1, nz)
  ...
  !>@details For one double precision 3D variable
  subroutine mn_var_shift_data_r8_3d_lowhighz(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, z_low, z_high)
    ...
    logical, intent(in)                         :: take_action                                  !< Perform move on this nest?
    type(nest_domain_type), intent(inout)       :: nest_domain                                  !< Nest domain structure
    integer, intent(in)                         :: position, nest_level, z_low, z_high          !< Grid offset, number vertical levels
  ...
  subroutine mn_var_shift_data_r4_4d(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
    ...
    do nq=1, n4d
      ...
      call mn_var_shift_data_r4_3d_highz(data_slice, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
  ...
  subroutine mn_var_shift_data_r8_4d(data_var, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
    ...
    do nq=1, n4d
      data_slice = data_var(:,:,:,nq)
      call mn_var_shift_data_r8_3d_highz(data_slice, interp_type, wt, ind, delta_i_c, delta_j_c, x_refine, y_refine, is_fine_pe, take_action, nest_domain, position, nest_level, nz)
      data_var(:,:,:,nq) = data_slice
    enddo
