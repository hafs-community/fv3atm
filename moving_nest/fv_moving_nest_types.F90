...
contains
  ...
  subroutine fv_moving_nest_physics_alloc_dealloc(mn_phys, GFS_Control, to_alloc)
    ...
    call alloc_dealloc_2d_r4(mn_phys%ts)

    if (move_physics) then
       call alloc_dealloc_2d_r4(mn_phys%slmsk)

       call alloc_dealloc_2d_r8(mn_phys%emis_lnd)
       call alloc_dealloc_2d_r8(mn_phys%emis_ice)
       call alloc_dealloc_2d_r8(mn_phys%emis_wat)

       !call alloc_dealloc_2d_r8(mn_phys%semis)
       !call alloc_dealloc_2d_r8(mn_phys%semisbase)
       !call alloc_dealloc_2d_r8(mn_phys%sfalb)

       call alloc_dealloc_2d_r8(mn_phys%u10m)
       call alloc_dealloc_2d_r8(mn_phys%v10m)
       call alloc_dealloc_2d_r8(mn_phys%tprcp)

       call alloc_dealloc_3d(mn_phys%hprime, GFS_Control%nmtvr)

       call alloc_dealloc_2d_r8(mn_phys%zorl)
       call alloc_dealloc_2d_r8(mn_phys%zorll)
       call alloc_dealloc_2d_r8(mn_phys%zorlwav)
       call alloc_dealloc_2d_r8(mn_phys%zorlw)

       call alloc_dealloc_2d_r8(mn_phys%usfco)
       call alloc_dealloc_2d_r8(mn_phys%vsfco)

       call alloc_dealloc_2d_r8(mn_phys%alvsf)
       call alloc_dealloc_2d_r8(mn_phys%alvwf)
       call alloc_dealloc_2d_r8(mn_phys%alnsf)
       call alloc_dealloc_2d_r8(mn_phys%alnwf)

       call alloc_dealloc_2d_r8(mn_phys%facsf)
       call alloc_dealloc_2d_r8(mn_phys%facwf)

       call alloc_dealloc_2d_r8(mn_phys%lakefrac)
       call alloc_dealloc_2d_r8(mn_phys%lakedepth)

       call alloc_dealloc_2d_r8(mn_phys%canopy)
       call alloc_dealloc_2d_r8(mn_phys%vegfrac)
       call alloc_dealloc_2d_r8(mn_phys%uustar)
       call alloc_dealloc_2d_r8(mn_phys%shdmin)
       call alloc_dealloc_2d_r8(mn_phys%shdmax)
       call alloc_dealloc_2d_r8(mn_phys%tsfco)
       call alloc_dealloc_2d_r8(mn_phys%tsfcl)
       call alloc_dealloc_2d_r8(mn_phys%tsfc)
       !call alloc_dealloc_2d_r8(mn_phys%tsfc_radtime)

       call alloc_dealloc_2d_r8(mn_phys%albdirvis_lnd)
       call alloc_dealloc_2d_r8(mn_phys%albdirnir_lnd)
       call alloc_dealloc_2d_r8(mn_phys%albdifvis_lnd)
       call alloc_dealloc_2d_r8(mn_phys%albdifnir_lnd)

       call alloc_dealloc_2d_r8(mn_phys%cv)
       call alloc_dealloc_2d_r8(mn_phys%cvt)
       call alloc_dealloc_2d_r8(mn_phys%cvb)

       call alloc_dealloc_2d_r8(mn_phys%pgr)
       call alloc_dealloc_2d_r8(mn_phys%tisfc)
       call alloc_dealloc_2d_r8(mn_phys%snowd)
       call alloc_dealloc_2d_r8(mn_phys%fice)
       call alloc_dealloc_2d_r8(mn_phys%sncovr)
       call alloc_dealloc_2d_int(mn_phys%scolor)
       call alloc_dealloc_2d_r8(mn_phys%hice)
       call alloc_dealloc_2d_r8(mn_phys%weasd)
       call alloc_dealloc_2d_r8(mn_phys%ffmm)
       call alloc_dealloc_2d_r8(mn_phys%ffhh)
       call alloc_dealloc_2d_r8(mn_phys%f10m)
       call alloc_dealloc_2d_r8(mn_phys%srflag)

       lsm_choice: if (GFS_Control%lsm == GFS_Control%lsm_noah .or. GFS_Control%lsm == GFS_Control%lsm_noahmp) then
          call alloc_dealloc_3d(mn_phys%smc, GFS_Control%lsoil)
          call alloc_dealloc_3d(mn_phys%stc, GFS_Control%lsoil)
          call alloc_dealloc_3d(mn_phys%slc, GFS_Control%lsoil)
       else
          call alloc_dealloc_3d(mn_phys%smois, GFS_Control%lsoil_lsm)
          call alloc_dealloc_3d(mn_phys%tslb, GFS_Control%lsoil_lsm)
          call alloc_dealloc_3d(mn_phys%sh2o, GFS_Control%lsoil_lsm)
       end if lsm_choice

       call alloc_dealloc_2d_r8(mn_phys%t2m)
       call alloc_dealloc_2d_r8(mn_phys%q2m)
       call alloc_dealloc_2d_r8(mn_phys%nirbmdi)
       call alloc_dealloc_2d_r8(mn_phys%nirdfdi)
       call alloc_dealloc_2d_r8(mn_phys%visbmdi)
       call alloc_dealloc_2d_r8(mn_phys%visdfdi)
       call alloc_dealloc_2d_r8(mn_phys%nirbmui)
       call alloc_dealloc_2d_r8(mn_phys%nirdfui)
       call alloc_dealloc_2d_r8(mn_phys%visbmui)
       call alloc_dealloc_2d_r8(mn_phys%visdfui)
       call alloc_dealloc_2d_r8(mn_phys%sfcdsw)
       call alloc_dealloc_2d_r8(mn_phys%sfcnsw)
       call alloc_dealloc_2d_r8(mn_phys%sfcdlw)
       call alloc_dealloc_2d_r8(mn_phys%sfalb)
       call alloc_dealloc_2d_r8(mn_phys%coszen)
       call alloc_dealloc_2d_r8(mn_phys%tsflw)
       call alloc_dealloc_2d_r8(mn_phys%semis)
       call alloc_dealloc_2d_r8(mn_phys%coszdg)

       call alloc_dealloc_2d_r8(mn_phys%sfcflw_upfxc)
       call alloc_dealloc_2d_r8(mn_phys%sfcflw_upfx0)
       call alloc_dealloc_2d_r8(mn_phys%sfcflw_dnfxc)
       call alloc_dealloc_2d_r8(mn_phys%sfcflw_dnfx0)
       call alloc_dealloc_2d_r8(mn_phys%sfcfsw_upfxc)
       call alloc_dealloc_2d_r8(mn_phys%sfcfsw_upfx0)
       call alloc_dealloc_2d_r8(mn_phys%sfcfsw_dnfxc)
       call alloc_dealloc_2d_r8(mn_phys%sfcfsw_dnfx0)

       call alloc_dealloc_3d(mn_phys%tiice, GFS_Control%kice)
       call alloc_dealloc_2d_r8(mn_phys%sncovr_ice)
      ...
      if (GFS_Control%use_cice_alb .or. GFS_Control%lsm == GFS_Control%lsm_ruc) then
       ! When copying back to GFS_Data, set albedo values to physically reasonable values if they have negative fill values.
         call alloc_dealloc_2d_r8(mn_phys%albdirvis_ice )
         call alloc_dealloc_2d_r8(mn_phys%albdirnir_ice )
         call alloc_dealloc_2d_r8(mn_phys%albdifvis_ice )
         call alloc_dealloc_2d_r8(mn_phys%albdifnir_ice )
      endif

      lsm_choice_2: if (GFS_Control%lsm == GFS_Control%lsm_noahmp) then
         call alloc_dealloc_2d_r8(mn_phys%snowxy)
         call alloc_dealloc_2d_r8(mn_phys%tvxy)
         call alloc_dealloc_2d_r8(mn_phys%tgxy)
         call alloc_dealloc_2d_r8(mn_phys%canicexy)
         call alloc_dealloc_2d_r8(mn_phys%canliqxy)
         call alloc_dealloc_2d_r8(mn_phys%eahxy)
         call alloc_dealloc_2d_r8(mn_phys%tahxy)
         call alloc_dealloc_2d_r8(mn_phys%cmxy)
         call alloc_dealloc_2d_r8(mn_phys%chxy)
         call alloc_dealloc_2d_r8(mn_phys%fwetxy)
         call alloc_dealloc_2d_r8(mn_phys%sneqvoxy)
         call alloc_dealloc_2d_r8(mn_phys%alboldxy)
         call alloc_dealloc_2d_r8(mn_phys%qsnowxy)
         call alloc_dealloc_2d_r8(mn_phys%wslakexy)
         call alloc_dealloc_2d_r8(mn_phys%zwtxy)
         call alloc_dealloc_2d_r8(mn_phys%waxy)
         call alloc_dealloc_2d_r8(mn_phys%wtxy)
         call alloc_dealloc_2d_r8(mn_phys%lfmassxy)
         call alloc_dealloc_2d_r8(mn_phys%rtmassxy)
         call alloc_dealloc_2d_r8(mn_phys%stmassxy)
         call alloc_dealloc_2d_r8(mn_phys%woodxy)
         call alloc_dealloc_2d_r8(mn_phys%stblcpxy)
         call alloc_dealloc_2d_r8(mn_phys%fastcpxy)
         call alloc_dealloc_2d_r8(mn_phys%xsaixy)
         call alloc_dealloc_2d_r8(mn_phys%xlaixy)
         call alloc_dealloc_2d_r8(mn_phys%taussxy)
         call alloc_dealloc_2d_r8(mn_phys%smcwtdxy)
         call alloc_dealloc_2d_r8(mn_phys%deeprechxy)
         call alloc_dealloc_2d_r8(mn_phys%rechxy)

        ! These five arrays use bizarre indexing.
         call alloc_dealloc_3d(mn_phys%snicexy, GFS_Control%lsnow_lsm_ubound - GFS_Control%lsnow_lsm_lbound + 1)
         call alloc_dealloc_3d(mn_phys%snliqxy, GFS_Control%lsnow_lsm_ubound - GFS_Control%lsnow_lsm_lbound + 1)
         call alloc_dealloc_3d(mn_phys%tsnoxy, GFS_Control%lsnow_lsm_ubound - GFS_Control%lsnow_lsm_lbound + 1)
         call alloc_dealloc_3d(mn_phys%smoiseq, GFS_Control%lsoil_lsm)
         call alloc_dealloc_3d(mn_phys%zsnsoxy, GFS_Control%lsoil_lsm - GFS_Control%lsnow_lsm_lbound + 1)
      elseif (GFS_Control%lsm == GFS_Control%lsm_ruc) then
         call alloc_dealloc_2d_r8(mn_phys%wetness)
         call alloc_dealloc_2d_r8(mn_phys%clw_surf_land)
         call alloc_dealloc_2d_r8(mn_phys%clw_surf_ice)
         call alloc_dealloc_2d_r8(mn_phys%qwv_surf_land)
         call alloc_dealloc_2d_r8(mn_phys%qwv_surf_ice)
         call alloc_dealloc_2d_r8(mn_phys%tsnow_land)
         call alloc_dealloc_2d_r8(mn_phys%tsnow_ice)
         call alloc_dealloc_2d_r8(mn_phys%snowfallac_land)
         call alloc_dealloc_2d_r8(mn_phys%snowfallac_ice)
         call alloc_dealloc_2d_r8(mn_phys%sfalb_lnd)
         call alloc_dealloc_2d_r8(mn_phys%sfalb_lnd_bck)
         call alloc_dealloc_2d_r8(mn_phys%sfalb_ice)
      ...
      if (GFS_Control%lkm > 0 .and. GFS_Control%iopt_lake==GFS_Control%iopt_lake_flake) then
         call alloc_dealloc_2d_r8(mn_phys%T_snow)
         call alloc_dealloc_2d_r8(mn_phys%T_ice)
         call alloc_dealloc_2d_r8(mn_phys%h_ML)
         call alloc_dealloc_2d_r8(mn_phys%t_ML)
         call alloc_dealloc_2d_r8(mn_phys%t_mnw)
         call alloc_dealloc_2d_r8(mn_phys%h_talb)
         call alloc_dealloc_2d_r8(mn_phys%t_talb)
         call alloc_dealloc_2d_r8(mn_phys%t_bot1)
         call alloc_dealloc_2d_r8(mn_phys%t_bot2)
         call alloc_dealloc_2d_r8(mn_phys%c_t)
      endif

       call alloc_dealloc_3d(mn_phys%phy_f2d, GFS_Control%ntot2d)
       call alloc_dealloc_4d(mn_phys%phy_f3d, GFS_Control%levs, GFS_Control%ntot3d)

       if (GFS_Control%nctp > 0 .and. GFS_Control%cscnv) then
          call alloc_dealloc_3d(mn_phys%phy_fctd, GFS_Control%nctp)
       endif

       call alloc_dealloc_3d(mn_phys%htrsw, GFS_Control%levs)
       call alloc_dealloc_3d(mn_phys%htrlw, GFS_Control%levs)
       call alloc_dealloc_3d(mn_phys%swhc, GFS_Control%levs)
       call alloc_dealloc_3d(mn_phys%lwhc, GFS_Control%levs)
    end if

    if (move_nsst) then
       call alloc_dealloc_2d_r8(mn_phys%tref)
       call alloc_dealloc_2d_r8(mn_phys%z_c)
       call alloc_dealloc_2d_r8(mn_phys%c_0)
       call alloc_dealloc_2d_r8(mn_phys%c_d)
       call alloc_dealloc_2d_r8(mn_phys%w_0)
       call alloc_dealloc_2d_r8(mn_phys%w_d)
       call alloc_dealloc_2d_r8(mn_phys%xt)
       call alloc_dealloc_2d_r8(mn_phys%xs)
       call alloc_dealloc_2d_r8(mn_phys%xu)
       call alloc_dealloc_2d_r8(mn_phys%xv)
       call alloc_dealloc_2d_r8(mn_phys%xz)
       call alloc_dealloc_2d_r8(mn_phys%zm)
       call alloc_dealloc_2d_r8(mn_phys%xtts)
       call alloc_dealloc_2d_r8(mn_phys%xzts)
       call alloc_dealloc_2d_r8(mn_phys%d_conv)
       !call alloc_dealloc_2d_r8(mn_phys%ifd)
       call alloc_dealloc_2d_r8(mn_phys%dt_cool)
       call alloc_dealloc_2d_r8(mn_phys%qrain)
    end if
