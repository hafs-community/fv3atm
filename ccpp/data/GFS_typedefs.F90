...
!--- vertical diffusion
    ...
    integer              :: newshear        !< choice of using updated shear effects in TKE-EDMF PBL & saSAS CP
...
!--- vertical diffusion
    ...
    integer              :: newshear       = 1               !< choice of using uodated shear effects in TKE-EDMF PBL & saSAS CP
...
!--- END NAMELIST VARIABLES
    ...
    NAMELIST /gfs_physics_nml/                                                              &
                          ...
                          !    vertical diffusion
                               ...
                               bl_upfr, bl_dnfr, rlmx, elmx, sfc_rlm, tc_pbl, newshear,     &
